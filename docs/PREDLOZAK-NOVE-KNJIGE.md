...
na ovu knjigu. Nije opis onoga kako bi knjiga trebala izgledati — sve brojke ovdje
izmjerene su iz te gotove knjige skriptom `npm run knjiga:mjere`.

> **Ovdje je predložak, u [`PLAN-KNJIGE.md`](PLAN-KNJIGE.md) je njegova primjena na
> „Istraživanje turističkog tržišta"** — sa svim odstupanjima od normi koje ovdje
> stoje. Kad ova knjiga bude napisana, `npm run knjiga:mjere` mjeri **nju**, pa se
> brojke u ovom dokumentu tada odnose na staru knjigu samo kao ishodište.
