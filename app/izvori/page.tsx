...
export default async function IzvoriPage() {
  // Prije nego što je baza povezana popis je jednostavno prazan — stranica i
  // dalje objašnjava čemu dopunski izvori služe.
  const dopunski = await getDopunskiIzvori().catch(() => []);
  ...
  return (
    <div className="page page-izvori">
      ...
      <section className="kartica">
        <h2>Izvor istine</h2>
        <p>
          Veleučilišni priručnik <strong>„Istraživanje turističkog tržišta&ldquo;</strong> jedini je izvor iz
