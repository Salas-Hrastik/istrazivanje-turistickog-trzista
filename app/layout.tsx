...
export const metadata: Metadata = {
  ...
  description:
    'Samostalni obrazovni AI asistent za kolegij Istraživanje turističkog tržišta — odgovara isključivo prema veleučilišnom priručniku, uz citiranje poglavlja i stranice.',
};
