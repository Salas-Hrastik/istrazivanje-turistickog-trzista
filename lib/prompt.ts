...
export const PRIRUCNIK = `veleučilišni priručnik „Istraživanje turističkog tržišta" (${config.ustanova})`;
...
6. Odgovaraš isključivo na hrvatskom jeziku, terminologijom usklađenom s priručnikom (npr. „sekundarni podaci", „probabilistički uzorak", „izviđajno istraživanje", „Likertova skala" — koristi točne pojmove iz izvora, ne sinonime iz opće literature). Dopunski izvori mogu biti na engleskom; pojmove prevedi u terminologiju priručnika.
